...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "iosplusAppSettings",
            dependencies: ["KeychainSwift", .product(name: "CocoaLumberjackSwift", package: "CocoaLumberjack")]),
        .testTarget(
            name: "iosplusAppSettingsTests",
            dependencies: ["iosplusAppSettings"]),
    ]
)
